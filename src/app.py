...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice team drills and compete in seasonal basketball games",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["leah@mergington.edu", "noah@mergington.edu"]
    },
    "Soccer Club": {
    ...
    "Science Olympiad": {
        "description": "Explore science experiments and compete in science events",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
